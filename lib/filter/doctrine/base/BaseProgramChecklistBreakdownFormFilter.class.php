...
/**
 * ProgramChecklistBreakdown filter form base class.
 *
 * @package    srmsnew
 * @subpackage filter
 * @author     EyuelG
 ...
 */
abstract class BaseProgramChecklistBreakdownFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'semester_min_chr' => new sfWidgetFormFilterInput(array('with_empty' => false)),
      'semester_max_chr' => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'semester_min_chr' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'semester_max_chr' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      'created_at'       => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 00:00:00')), 'to_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 23:59:59')))),
      'updated_at'       => new sfValidatorDateRange(array('required' => false, 'from_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 00:00:00')), 'to_date' => new sfValidatorDateTime(array('required' => false, 'datetime_output' => 'Y-m-d 23:59:59')))),
    ));

    $this->widgetSchema->setNameFormat('program_checklist_breakdown_filters[%s]');
  ...
  public function getFields()
  {
    return array(
      ...
      'year'             => 'Number',
      'semester'         => 'Number',
      'semester_min_chr' => 'Number',
      'semester_max_chr' => 'Number',
      'created_at'       => 'Date',
      'updated_at'       => 'Date',
    );
  }
