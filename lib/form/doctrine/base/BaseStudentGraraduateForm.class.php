...
/**
 * StudentGraraduate form base class.
 *
 * @method StudentGraraduate getObject() Returns the current form's model object
 *
 * @package    srmsnew
 * @subpackage form
 * @author     EyuelG
 ...
 */
abstract class BaseStudentGraraduateForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('student_graraduate[%s]');
