...
abstract class BasesfGuardUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'user_id_number'     => new sfWidgetFormInputText(),
      'id_number'          => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'user_id_number'     => new sfValidatorString(array('max_length' => 255)),
      'id_number'          => new sfValidatorString(array('max_length' => 255)),
