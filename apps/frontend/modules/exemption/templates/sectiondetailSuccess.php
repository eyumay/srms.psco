...
<div style="font-size:12px;"> 
    <table border="1" style="font-size:11px; background-color:white" cellpadding="4px" width="600px">
        ...
        <tr>
            ...
            <td valign="top">
                <a href="<?php echo url_for('exemption/studentExemptionDetail?sectionId='.$enrollment->getSectionId().'&studentId='.$enrollment->getStudentId().'&enrollmentId='.$enrollment->getId()) ?>">
                    Goto Exemption
                </a>
            </td>
        </tr> 
