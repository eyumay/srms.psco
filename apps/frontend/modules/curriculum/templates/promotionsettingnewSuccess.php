<?php use_stylesheets_for_form($frontendPromotionSettingForm) ?>
<?php use_javascripts_for_form($frontendPromotionSettingForm) ?>
...
<hr />
<form action="<?php echo url_for('curriculum/promotionsettingnew?programId='.$program->getId()); ?>" method="post">
    <?php echo $frontendPromotionSettingForm; ?>
