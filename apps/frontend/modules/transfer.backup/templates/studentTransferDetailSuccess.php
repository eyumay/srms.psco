        ...
        <tr>
            ...
            <td valign="top">  
                <table width="100%" border="0" style="font-size:11px; background-color:white" align="center">
                    <!-- TO NEW CENTER START -->                    
                    <form action="<?php echo url_for('transfer/studentTransferDetail?sectionId='.$programSectionId.'&studentId='.$studentId.'&enrollmentId='.$enrollmentId) ?>" method="post">
                        <?php if($showToSectionForm): ?>
                        <td>
                            <?php echo $transferForm; ?>                                                                                                
                        </td>
